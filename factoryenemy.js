...
function enemyFactory(type) {
  if (type === 'left1') {
    return new Enemy({ ctx: canvas.getContext('2d'), image: left1, width: 1200, height: 86, positionX: 250, positionY: positiony(100), type: 'run1', frameIndex: 0, numberOfFrames: 12, ticksPerFrame: 4, live: 100})
  } else if (type === 'left2') {
    return new Enemy({ ctx: canvas.getContext('2d'), image: left2, width: 1180, height: 88, positionX: 250, positionY: positiony(100), type: 'run2', frameIndex: 0, numberOfFrames: 12, ticksPerFrame: 5, live: 100})
  } else if (type === 'left3') {
    return new Enemy({ ctx: canvas.getContext('2d'), image: left3, width: 1092, height: 84, positionX: 250, positionY: positiony(100), type: 'run3', frameIndex: 0, numberOfFrames: 14, ticksPerFrame: 4, live: 100})
  } else if (type === 'left4') {
